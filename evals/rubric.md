...
Watch for template choice. The biggest failure mode is using the new-feature template when an adjustment template is warranted. Adjustments have no "Critères d'acceptabilité" header (they use "Comportement souhaité" instead).
