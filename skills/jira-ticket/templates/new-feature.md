...
- [ ] **Issue type**: choisi au Step 2 dans la liste retournée par `Atlassian:getJiraProjectIssueTypesMetadata` (recommandation par défaut pour cet artefact : `Story` si le projet l'expose, sinon `Task`). Verrouillé après le Step 2, plus ré-interviewé au Step 5.
